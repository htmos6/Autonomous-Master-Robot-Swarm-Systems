...
{ 
	...
	printf("-------------- done --------------\n\n");
    std::cout << "Gyroscope R,P,Y: " << OffsetResult[3] << "," << OffsetResult[4] << "," << OffsetResult[5] << "\nAccelerometer X,Y,Z: " << OffsetResult[0] << "," << OffsetResult[1] << "," << OffsetResult[2] << "\n";
	return 0;
}